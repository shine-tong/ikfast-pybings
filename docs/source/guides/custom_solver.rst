...
English | :doc:`中文文档 <custom_solver_cn>`
...
`ikfast-online README <https://github.com/shine-tong/ikfast-online>`__.

.. important::

   The solver filename must follow the pattern ``*_ikfast_solver.cpp``.
...
.. warning::
   ...
   Multiple IKFast solver files found:
   ['src/robot_a_ikfast_solver.cpp', 'src/robot_b_ikfast_solver.cpp']
...
2. Regenerate the IKFast solver with the correct robot model.
...
1. Wrong solver file (for a different robot).
2. Different coordinate frame conventions.
3. Joint angle units mismatch (radians vs degrees).
...
3. Compare results with OpenRAVE if needed.


Example: Using ikfast-online with a 6-DOF Robot
-----------------------------------------------
...
- **ikfast-online**: https://github.com/shine-tong/ikfast-online  
